...
public class ItemService {
    ...
    public static ArrayList<ItemDetailModel> items = new ArrayList<ItemDetailModel>(Arrays.asList(
            new ItemDetailModel(0,"Toaster","A Toaster","The most wickedly awesome toaster in existence.",3),
            new ItemDetailModel(1,"Rock Toaster","A Toaster","The most rockin toaster straight from the depths of Hell.",3),
            new ItemDetailModel(2,"Rocktastic Box","A Toaster","The punk-ish little toaster that only appeals to Middle-Schoolers.",3),
            new ItemDetailModel(3,"Toaster Box","A Toaster","This Toaster comes in an exciting box shape.",3),
            new ItemDetailModel(4,"Holy Roaster","A Toaster","This Toaster creates little slices of heaven!",3),
            new ItemDetailModel(5,"Smokester","A Toaster","Dude, like, this toaster man, woah.",3),
            new ItemDetailModel(6,"Bread Roaster","A Toaster","The first Toaster ever made! Makes toast without the need for peasants!",3),
            new ItemDetailModel(7,"Mythic Toaster","A Toaster","A Toaster of legend. Used to summon our Lord Dagon.",3),
            new ItemDetailModel(8,"Mythic Roaster","A Toaster","A cheap imitation of the legendary Mythic Toaster.",3)
    ));
    ...
    public static ArrayList<ItemDetailModel> search(String query){
        ...
        if(splitStrings.length==1)
            return (ArrayList)CollectionUtils.filter(items, new CollectionUtils.Search<ItemDetailModel>(query));
        ...
        if(input.size()==1)
            return (ArrayList)CollectionUtils.filter(items, new CollectionUtils.Search<ItemDetailModel>(input.get(0)));
    ...
    public static ItemDetailModel bid(int id, float bidIncrease){
